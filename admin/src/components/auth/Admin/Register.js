...
import { register } from "../../../actions/authA";
...
const RegisterA = ({ setAlert, register, isAuthenticated }) => {
  ...
  const { first_name, last_name, email, fonction, password, confirmPassword } =
    formData;
  ...
  const onSubmit = async (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      register({ first_name, last_name, email, fonction, password });
    }
  };
  if (isAuthenticated) {

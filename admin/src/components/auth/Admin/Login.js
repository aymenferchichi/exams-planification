...
import { login } from "../../../actions/authA";
import { Navigate } from "react-router-dom";

const LoginA = ({ login, isAuthenticated }) => {
              ...
              <form className="mt-10" onSubmit={(e) => onSubmit(e)}>
                ...
                <div className="mt-7">
                  <div className="flex justify-center items-center">
                    <label className="mr-2">Have no account!</label>
                    <a
                      href="/admin/register"
                      className=" text-blue-500 font-bold transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105"
                    >
                      sign up
                    </a>
                  </div>
...
export default connect(mapStateToPorps, { login })(LoginA);
